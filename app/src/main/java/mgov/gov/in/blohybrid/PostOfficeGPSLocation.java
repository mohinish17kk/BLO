...
public class PostOfficeGPSLocation extends AppCompatActivity {
    ...
    EditText etpollingaddress,etpollingaddress2,etpollingaddres3,etpollingaddress4,etareapincodecovered;
    Button btn_submit;
    TextView tvpollinggps, tvfetched,tvfetched1, tvhome,tvshow;
    CheckBox cbamf;
    DatabaseHelper myDb;
    ProgressDialog pd;
    RequestQueue queue;
    JSONObject jsonBody = new JSONObject();
    String slatlong,AddressPin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etareapincodecovered = (EditText) findViewById(R.id.etareapincodecovered);
        ...
        tvhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(PostOfficeGPSLocation.this,WelcomeBLONew.class);
        ...
        tvshow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showProgressDialog();
                Cursor cursor = myDb.getAllDatafromTable8();
                ...
                while (cursor.moveToNext()){
                    ...
                    stringBuffer.append("PO_AREA_PINCODE : "+ cursor.getString(4)+"\n\n");
        ...
        ActivityCompat.requestPermissions(PostOfficeGPSLocation.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},123);
        tvpollinggps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (g.isGPSEnabled){
                    ...
                    Toast.makeText(PostOfficeGPSLocation.this, getApplicationContext().getResources().getString(R.string.Please_Enable_GPS), Toast.LENGTH_SHORT).show();
                }
                /*if(l.equals(null)){
    ...
    private void submit(){
        ...
        keyVal.put("PO_AREA_PINCODE",etareapincodecovered.getText().toString());
        ...
        try {
            ...
            jsonBody.put("PO_AREA_PINCODE",etareapincodecovered.getText().toString());
        ...
        boolean isInserted = myDb.insertPOGPSLocationData(etpollingaddress.getText().toString(),etpollingaddress2.getText().toString(),AddressPin.toString(),
                slatlong.toString(),etareapincodecovered.getText().toString(),"false");
        if(isInserted = true){
    ...
    private boolean areapincode() {
        if(etareapincodecovered.getText().toString().isEmpty() || etareapincodecovered.length()!=6)
        {
            Toast.makeText(getApplicationContext(),getApplicationContext().getResources().getString(R.string.Enter_Area_Pin_Code_covered_under_the_Post_Office_At_least_One), Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
    ...
    private boolean GPS() {
        ...
        {
            Toast.makeText(getApplicationContext(),getApplicationContext().getResources().getString(R.string.Please_Enable_GPS),Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }

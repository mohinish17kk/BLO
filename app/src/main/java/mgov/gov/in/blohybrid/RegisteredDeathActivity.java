...
public class RegisteredDeathActivity extends AppCompatActivity {

    ListView listView;
    RequestQueue queue;
    ProgressDialog pd;
    SharedPreferences prefs;
    String mob,stcode,acno,partno,url,error_type,sauto,isVerified,SharedKey,url1,IP_HEADER;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registered_death);
        final Dialog dialogg = new Dialog(RegisteredDeathActivity.this);
        ...
        url = IP_HEADER+"Get_ASDRecords?st_code="+stcode+"&ac_no="+acno+"&part_no="+partno+"&mobile_no="+mob+"&asd_code=3";
        Log.d("url",url);

        listView = (ListView) findViewById(R.id.registeredDeathListView);
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        try {
                                            ...
                                            if(IsSuccess.trim().equals("true")) {
                                                final Dialog dialog = new Dialog(RegisteredDeathActivity.this);
...
*/
        ...
        tvhome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RegisteredDeathActivity.this, WelcomeBLONew.class);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for(int i=0; i < jArray.length(); i++) {
                    ...
                    String UserName = jsreceipt.getString("UserName");
                   ...
                   // data.put("AUTO_ID",AUTO_ID);
                    ...
                    ListAdapter la = new SimpleAdapter(getApplicationContext(), dataAL, R.layout.custom_registered_death_listview_item,
                            new String[]{"UserName", "EPIC_NO", "GENDER", "SerialNo","AUTO_ID"},
                            new int[]{R.id.tvname, R.id.tvepicno, R.id.tvgender, R.id.tvserialno, R.id.tvautoid});
                ...
                Intent intent=new Intent(RegisteredDeathActivity.this,WelcomeBLO.class);
                startActivity(intent);
                finish();
            }
            finally {

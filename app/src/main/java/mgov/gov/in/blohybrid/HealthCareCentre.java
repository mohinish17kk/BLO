...
public class HealthCareCentre extends AppCompatActivity {
    EditText etpollingaddress,etpollingaddress2,etpollingaddres3,etpollingaddress4;
    Button btn_submit;
    TextView tvpollinggps, tvfetched,tvfetched1, tvhome,tvshow,etHCmob;
    CheckBox cbamf;
    DatabaseHelper myDb;
    ProgressDialog pd;
    RequestQueue queue;
    ...
    String mob,stcode,acno,partno,sHCmob,IP_HEADER;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etHCmob = (EditText) findViewById(R.id.etHCmob);
        ...
        tvhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(HealthCareCentre.this,WelcomeBLONew.class);
        ...
        tvshow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showProgressDialog();
                Cursor cursor = myDb.getAllDatafromTable13();
        ...
        ActivityCompat.requestPermissions(HealthCareCentre.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},123);
        tvpollinggps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (g.isGPSEnabled){
                    ...
                    Toast.makeText(HealthCareCentre.this, getApplicationContext().getResources().getString(R.string.Please_Enable_GPS), Toast.LENGTH_SHORT).show();
                }
                /*if(l.equals(null)){
    ...
    private void submit(){
        ...
        if(etHCmob.getText().toString().isEmpty()){
            sHCmob = "";
        }else sHCmob = etHCmob.getText().toString();
        ...
        boolean isInserted = myDb.insertHealthCareCentreData(etpollingaddress.getText().toString(),etpollingaddress2.getText().toString(),AddressPin.toString(),
                slatlong.toString(),sHCmob,"false");
        if(isInserted = true){
            final Dialog dialog = new Dialog(HealthCareCentre.this);
    ...
    private boolean mobile() {
        if(!(etHCmob.getText().toString().isEmpty()) && etHCmob.length()<10)
        {

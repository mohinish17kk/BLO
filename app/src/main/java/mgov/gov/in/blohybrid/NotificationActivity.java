...
public class NotificationActivity extends AppCompatActivity {
    TextView tvhome,tvnotification;
    RequestQueue queue;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ConnectionStatus.isNetworkConnected(NotificationActivity.this)) {
    ...
    class RequestTask1 extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                String total = String.valueOf(jArray.length());
                if(String.valueOf(jArray.length()).equals("0") || String.valueOf(jArray.length())=="0"){
                    ...
                    tvnotification.setText(getApplicationContext().getResources().getString(R.string.You_are_having)+" "+total+ " "+ getApplicationContext().getResources().getString(R.string.new_work_to_be_done));
                }
